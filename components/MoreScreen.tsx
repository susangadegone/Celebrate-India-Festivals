...
export default function MoreScreen() {
  return (
    <div className="space-y-6 pb-6">
      ...
      >
        <Card className="bg-gradient-to-br from-[#F7F1E8] to-white border border-[#D9A95C]/30 shadow-lg rounded-3xl">
          <CardContent className="p-6">
            <div className="flex items-start gap-4">
              <Info className="w-6 h-6 text-[#5B8A8C] flex-shrink-0 mt-1" />
              <div className="flex-1">
                <h3 className="text-xl font-bold text-[#8E84A6] mb-3">About This App</h3>
                ...
                <div className="space-y-2 text-sm text-gray-600">
                  <div className="flex items-center gap-2">
                    <Calendar className="w-4 h-4 text-[#5B8A8C]" />
                    <span>47+ authentic festivals</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <Sparkles className="w-4 h-4 text-[#5B8A8C]" />
                    <span>Daily Sai Baba quotes</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <Globe className="w-4 h-4 text-[#5B8A8C]" />
      ...
      >
        <Card className="bg-gradient-to-br from-[#5B8A8C]/10 to-[#C97B84]/10 border border-[#5B8A8C]/20 rounded-3xl">
          <CardContent className="p-6">
            <div className="flex items-center justify-center gap-2 mb-2">
              <Heart className="w-5 h-5 text-[#5B8A8C]" />
