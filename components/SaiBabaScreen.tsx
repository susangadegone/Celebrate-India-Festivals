  ...
  return (
    <div className="space-y-6 pb-6">
      ...
      {isThursday && thursdayBlessing && (
        ...
        >
          <Card className="bg-gradient-to-br from-[#5B8A8C] via-[#C97B84] to-[#8E84A6] border-0 shadow-2xl rounded-3xl overflow-hidden">
      ...
      >
        <Card className="bg-gradient-to-br from-[#F7F1E8] via-white to-[#F7F1E8] border-2 border-[#D9A95C]/50 shadow-xl rounded-3xl">
          <CardContent className="p-6 md:p-8">
            <div className="text-center space-y-4">
              <Sparkles className="w-8 h-8 text-[#5B8A8C] mx-auto" />
              <h3 className="text-xl font-bold text-[#8E84A6]">
                Quote of the Day
              </h3>
              <p className="text-2xl md:text-3xl text-[#C97B84] leading-relaxed italic font-medium">
                "{quoteOfTheDay}"
              </p>
              <p className="text-sm text-[#C97B84]/70 font-semibold">— Sai Baba</p>
            </div>
          </CardContent>
        </Card>
      </motion.div>
      ...
      >
        <div className="flex items-center justify-between">
          <h2 className="text-2xl font-bold text-gray-900 flex items-center gap-2">
            <Heart className="w-6 h-6 text-[#5B8A8C]" />
            All Blessings
          </h2>
          <button
            onClick={() => setShowAllQuotes(!showAllQuotes)}
            className="text-[#5B8A8C] font-semibold text-sm px-4 py-2 rounded-full bg-[#F7F1E8] hover:bg-[#D9A95C]/20 transition-colors touch-manipulation"
          >
              ...
              >
                <Card className="bg-white border border-gray-200 shadow-md hover:shadow-lg rounded-2xl transition-all">
                  <CardContent className="p-5">
                    ...
                    <p className="text-xs text-[#C97B84]/70 mt-3 font-medium">— Sai Baba</p>
                  </CardContent>
                </Card>
              </motion.div>
            ))}
